var x1 = x - sprite_get_width(spr_kafshdoozak_1024)/2;
var y1 = y - sprite_get_height(spr_kafshdoozak_1024)/2;
var x2 = x + sprite_get_width(spr_kafshdoozak_1024)/2;
var y2 = y + sprite_get_height(spr_kafshdoozak_1024)/2;

if(collision_rectangle(x1, y1, x2, y2, obj_egg_base, false, true) > 0){
    scr_event_occurred("positive");
    ...
    /*
     ...
     for(var i = 0;i < chNegtv; i++){
        with(instance_find(obj_phy_negative, i)){
        mode="khaste";
        }
     }
      subImg+=1;
